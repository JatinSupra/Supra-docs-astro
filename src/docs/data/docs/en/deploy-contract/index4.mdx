---
title: Move
description: Learn about MoveVM
tab: deploy
sidebar:
  order: 2
  label: Move
---
Learn how Move powers secure and predictable smart contracts on the Supra L1.
...
## What is Move?
*A resource-oriented programming language designed for safe and predictable smart contracts.*
...
Originally developed for Diem (Meta’s blockchain project), Move has evolved into a powerful ecosystem language used by several modern blockchains, including Supra, Aptos, and Sui. On Supra, Move ensures each transaction executes with precision and security, making it ideal for both financial and enterprise-grade applications.

## Why Learn Move?
*Because Move gives you fine-grained control and built-in safety for digital assets.*

Move introduces a unique resource-based type system that enforces strong ownership rules at the language level. Assets in Move can’t be duplicated or destroyed without explicit permission, meaning developers don’t have to rely solely on external audits or manual safety checks.
Learning Move helps you write more secure and predictable code from the start. It’s perfect for developers who want to create high-performance dApps, design custom tokens, or work with complex logic, without sacrificing safety or composability.

## How Does Move Work?
*Write modules, compile them, and deploy them directly to the blockchain.*
...
## What Can You Build With Move?
*Applications built with security and scalability at their core.*
